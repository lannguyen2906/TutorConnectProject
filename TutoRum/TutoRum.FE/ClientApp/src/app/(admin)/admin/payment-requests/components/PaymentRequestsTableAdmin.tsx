...
import DownloadPaymentRequestsButton from "@/components/ui/download-payment-requests";
import UploadPaymentRequestsButton from "@/components/ui/upload-payment-requests";
...
const PaymentRequestsTableAdmin = () => {
  ...
  return (
    <div className="space-y-4">
      ...
      />
      <div className="flex gap-2">
        <DownloadPaymentRequestsButton />
        <UploadPaymentRequestsButton />
      </div>
      <Table
        pagination={{
