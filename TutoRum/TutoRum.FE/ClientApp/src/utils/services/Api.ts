...
export interface DashboardChartData {
  monthlyRevenues?: MonthlyRevenueData[] | null;
  tutorsByCity?: TutorsByCityData[] | null;
  learnersByCity?: LearnersByCityData[] | null;
  feedbackByQualificationLevels?: FeedbackByQualificationLevelData[] | null;
  tutorsBySubjects?: TutorsBySubjectData[] | null;
}

export interface DashboardChartDataApiResponse {
  /** @format int32 */
  status?: number;
  success?: boolean;
  message?: string | null;
...
export interface DashboardKeyMetricsDto {
  /** @format double */
  totalRevenue?: number | null;
  /** @format int32 */
  numberOfTutors?: number | null;
  /** @format int32 */
  numberOfLearners?: number | null;
  /** @format int32 */
  numberOfClassrooms?: number | null;
  /** @format int32 */
  numberOfPendingPaymentRequests?: number | null;
}

export interface DashboardKeyMetricsDtoApiResponse {
  /** @format int32 */
  status?: number;
  success?: boolean;
  message?: string | null;
  data?: DashboardKeyMetricsDto;
  errors?: ApiError[] | null;
  timestamp?: string | null;
}
...
export interface FeedbackByQualificationLevelData {
...
export interface LearnersByCityData {
  city?: string | null;
  /** @format int32 */
  learnerCount?: number;
}
...
export interface TutorSummaryDto {
  ...
  /** @format double */
  numberOfTeachingHour?: number | null;
  certificates?: CertificateDTO[] | null;
  tutorSubjects?: TutorSubjectDto[] | null;
  teachingLocations?: TeachingLocationViewDTO[] | null;
  schedules?: ScheduleDTO[] | null;
...
export interface TutorsByCityData {
  city?: string | null;
  /** @format int32 */
  tutorCount?: number;
}

export interface TutorsBySubjectData {
  subject?: string | null;
  /** @format int32 */
  tutorCount?: number;
}
...
export class HttpClient<SecurityDataType = unknown> {
  ...
  constructor({ securityWorker, secure, format, ...axiosConfig }: ApiConfig<SecurityDataType> = {}) {
      this.instance = axios.create({ ...axiosConfig, baseURL: axiosConfig.baseURL || "https://tutorconnectapiservice-hkhecjd7azg2gcfm.southeastasia-01.azurewebsites.net" });
    this.secure = secure;
    this.format = format;
...
export class Api<SecurityDataType extends unknown> {
  ...
  api = {
     ...
     *
     * @tags Admin
     * @name AdminGetDashboardKeyMetricsList
     * @request GET:/api/Admin/GetDashboardKeyMetrics
     * @secure
     */
    adminGetDashboardKeyMetricsList: (params: RequestParams = {}) =>
      this.http.request<DashboardKeyMetricsDtoApiResponse, any>({
        path: `/api/Admin/GetDashboardKeyMetrics`,
        method: "GET",
        secure: true,
        format: "json",
        ...params,
     ...
     *
     * @tags Admin
     * @name AdminGetDashboardChartsDataList
     * @request GET:/api/Admin/GetDashboardChartsData
     * @secure
     */
    adminGetDashboardChartsDataList: (params: RequestParams = {}) =>
      this.http.request<DashboardChartDataApiResponse, any>({
        path: `/api/Admin/GetDashboardChartsData`,
        method: "GET",
        secure: true,
        format: "json",
        ...params,
     ...
     *
     * @tags BillingEntry
     * @name BillingEntryVerifyBillingEntryUpdate
     * @request PUT:/api/BillingEntry/VerifyBillingEntry
     * @secure
     */
    billingEntryVerifyBillingEntryUpdate: (
      query?: {
        /** @format int32 */
        billingEntryId?: number;
        isVerified?: boolean;
      ...
      this.http.request<ObjectApiResponse, any>({
        path: `/api/BillingEntry/VerifyBillingEntry`,
        method: "PUT",
        query: query,
        secure: true,
        format: "json",
     ...
     *
     * @tags PaymentRequest
     * @name PaymentRequestUploadPaymentRequestsCreate
     * @request POST:/api/PaymentRequest/upload-payment-requests
     * @secure
     */
    paymentRequestUploadPaymentRequestsCreate: (
      data: {
        /** @format binary */
        file?: File;
      },
      ...
      this.http.request<void, any>({
        path: `/api/PaymentRequest/upload-payment-requests`,
        method: "POST",
        body: data,
        secure: true,
     ...
     *
     * @tags PaymentRequest
     * @name PaymentRequestDownloadPaymentRequestsList
     * @request GET:/api/PaymentRequest/download-payment-requests
     * @secure
     */
    paymentRequestDownloadPaymentRequestsList: (params: RequestParams = {}) =>
      this.http.request<void, any>({
        path: `/api/PaymentRequest/download-payment-requests`,
        method: "GET",
        secure: true,
        ...params,
      }),
