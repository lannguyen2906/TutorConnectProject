    ...
    public static class Url
    {
        public static class User
        {
            ...
            public static class Admin 
            {
                ...
                public const string GetDashboardKeyMetrics = "GetDashboardKeyMetrics";
                public const string GetDashboardChartsData = "GetDashboardChartsData";
            ...
            public static class BillingEntry
            {
                ...
                public const string VerifyBillingEntry = "VerifyBillingEntry";
