...
namespace TutoRum.UnitTests.ServiceUnitTest
{
    public class AdminServiceUnitTest
    {
        ...
        private Mock<ITutorLearnerSubjectService> _tutorLearnerSubjectService;
        ...
        public void SetUp()
        {
            ...
            _notificationMock = new Mock<INotificationService>(); // Khởi tạo mock cho INotificationService
            _tutorLearnerSubjectService = new Mock<ITutorLearnerSubjectService>();
            ...
            _adminService = new AdminSevice(
                ...
                _tutorLearnerSubjectService.Object
                // Truyền thêm dependency này
            );
        }
